...
namespace UIRes
{
    public partial class EquipCell3 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jj3e21hn";

        public static EquipCell3 CreateInstance()
        {
            return (EquipCell3)UIPackage.CreateObject("UIRes", "EquipCell3");
        }
