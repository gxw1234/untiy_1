...
namespace UIRes
{
    public partial class EquipCell20 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21i3";

        public static EquipCell20 CreateInstance()
        {
            return (EquipCell20)UIPackage.CreateObject("UIRes", "EquipCell20");
        }
