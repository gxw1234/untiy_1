...
namespace UIRes
{
    public partial class DWHouseItem : GComponent
    {
        public GImage bg;
        ...
        public GImage WHouseSelectBg;
        public const string URL = "ui://jk0io98jj3e21f9";

        public static DWHouseItem CreateInstance()
        {
            return (DWHouseItem)UIPackage.CreateObject("UIRes", "DWHouseItem");
        }
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            WHouseSelectBg = (GImage)GetChild("WHouseSelectBg");
        }
    }
}