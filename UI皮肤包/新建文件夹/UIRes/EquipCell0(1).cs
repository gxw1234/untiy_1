...
namespace UIRes
{
    public partial class EquipCell0(1) : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jnl1f7";

        public static EquipCell0(1) CreateInstance()
        {
            return (EquipCell0(1))UIPackage.CreateObject("UIRes", "EquipCell0(1)");
        }
