...
namespace UIRes
{
    public partial class EquipCell27 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21ia";

        public static EquipCell27 CreateInstance()
        {
            return (EquipCell27)UIPackage.CreateObject("UIRes", "EquipCell27");
        }
