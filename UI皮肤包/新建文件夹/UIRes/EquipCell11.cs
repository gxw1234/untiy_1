...
namespace UIRes
{
    public partial class EquipCell11 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jj3e21hs";

        public static EquipCell11 CreateInstance()
        {
            return (EquipCell11)UIPackage.CreateObject("UIRes", "EquipCell11");
        }
