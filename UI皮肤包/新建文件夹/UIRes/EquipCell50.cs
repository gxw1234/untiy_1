...
namespace UIRes
{
    public partial class EquipCell50 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21il";

        public static EquipCell50 CreateInstance()
        {
            return (EquipCell50)UIPackage.CreateObject("UIRes", "EquipCell50");
        }
