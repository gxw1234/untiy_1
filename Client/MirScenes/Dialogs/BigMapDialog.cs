...
namespace Client.MirScenes.Dialogs
{
    ...
    public sealed class BigMapViewPort : MirControl
    {
        ...
        private void OnBeforeDraw()
        {
            ...
            UnityEngine.Rect viewRect1 = viewRect.ToRect1(viewRect.Height);
             UnityEngine.Texture2D croppedTexture = GameScene.Scene.CropTexture(miniMapTexture1, viewRect1, startPointX, startPointY);
             //mapTexture.Dispose();
