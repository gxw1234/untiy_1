...
namespace UIRes
{
    public partial class EquipCell67 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jrd2mh";

        public static EquipCell67 CreateInstance()
        {
            return (EquipCell67)UIPackage.CreateObject("UIRes", "EquipCell67");
        }
