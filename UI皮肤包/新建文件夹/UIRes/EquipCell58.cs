...
namespace UIRes
{
    public partial class EquipCell58 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21it";

        public static EquipCell58 CreateInstance()
        {
            return (EquipCell58)UIPackage.CreateObject("UIRes", "EquipCell58");
        }
