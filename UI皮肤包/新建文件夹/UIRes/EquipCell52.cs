...
namespace UIRes
{
    public partial class EquipCell52 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21in";

        public static EquipCell52 CreateInstance()
        {
            return (EquipCell52)UIPackage.CreateObject("UIRes", "EquipCell52");
        }
