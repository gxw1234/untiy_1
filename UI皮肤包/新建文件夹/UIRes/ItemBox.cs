...
namespace UIRes
{
    public partial class ItemBox : GComponent
    {
        ...
        public GLoader Select;
        public const string URL = "ui://jk0io98jhdg7vn2sq";

        public static ItemBox CreateInstance()
        {
            return (ItemBox)UIPackage.CreateObject("UIRes", "ItemBox");
        }
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            Select = (GLoader)GetChild("Select");
        }
    }
}