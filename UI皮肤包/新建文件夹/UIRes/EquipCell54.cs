...
namespace UIRes
{
    public partial class EquipCell54 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jklw73";

        public static EquipCell54 CreateInstance()
        {
            return (EquipCell54)UIPackage.CreateObject("UIRes", "EquipCell54");
        }
