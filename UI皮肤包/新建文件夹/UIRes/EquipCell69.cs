...
namespace UIRes
{
    public partial class EquipCell69 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jupk4t";

        public static EquipCell69 CreateInstance()
        {
            return (EquipCell69)UIPackage.CreateObject("UIRes", "EquipCell69");
        }
