...
namespace UIRes
{
    public partial class EquipCell14 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jj3e21hx";

        public static EquipCell14 CreateInstance()
        {
            return (EquipCell14)UIPackage.CreateObject("UIRes", "EquipCell14");
        }
