...
namespace UIRes
{
    public partial class EquipCell17 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jxn1gs";

        public static EquipCell17 CreateInstance()
        {
            return (EquipCell17)UIPackage.CreateObject("UIRes", "EquipCell17");
        }
