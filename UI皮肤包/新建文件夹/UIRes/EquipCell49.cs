...
namespace UIRes
{
    public partial class EquipCell49 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21ik";

        public static EquipCell49 CreateInstance()
        {
            return (EquipCell49)UIPackage.CreateObject("UIRes", "EquipCell49");
        }
