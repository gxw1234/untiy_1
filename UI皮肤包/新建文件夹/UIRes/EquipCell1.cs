...
namespace UIRes
{
    public partial class EquipCell1 : GComponent
    {
        public GLoader bg;
        ...
        public const string URL = "ui://jk0io98jkn5zzm";

        public static EquipCell1 CreateInstance()
        {
            return (EquipCell1)UIPackage.CreateObject("UIRes", "EquipCell1");
        }
