...
namespace UIRes
{
    public partial class EquipCell9 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jk50ea";

        public static EquipCell9 CreateInstance()
        {
            return (EquipCell9)UIPackage.CreateObject("UIRes", "EquipCell9");
        }
