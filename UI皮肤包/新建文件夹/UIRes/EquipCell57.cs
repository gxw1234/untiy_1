...
namespace UIRes
{
    public partial class EquipCell57 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jvyqpi";

        public static EquipCell57 CreateInstance()
        {
            return (EquipCell57)UIPackage.CreateObject("UIRes", "EquipCell57");
        }
