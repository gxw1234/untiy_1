...
namespace UIRes
{
    public partial class EquipCell38 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jq";

        public static EquipCell38 CreateInstance()
        {
            return (EquipCell38)UIPackage.CreateObject("UIRes", "EquipCell38");
        }
