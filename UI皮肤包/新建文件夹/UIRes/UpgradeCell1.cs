...
namespace UIRes
{
    public partial class UpgradeCell1 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jhdg7vn2sh";

        public static UpgradeCell1 CreateInstance()
        {
            return (UpgradeCell1)UIPackage.CreateObject("UIRes", "UpgradeCell1");
        }
