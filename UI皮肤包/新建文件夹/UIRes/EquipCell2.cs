...
namespace UIRes
{
    public partial class EquipCell2 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jj3e21ho";

        public static EquipCell2 CreateInstance()
        {
            return (EquipCell2)UIPackage.CreateObject("UIRes", "EquipCell2");
        }
