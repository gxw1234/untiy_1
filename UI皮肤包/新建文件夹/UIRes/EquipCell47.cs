...
namespace UIRes
{
    public partial class EquipCell47 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jk2v2m";

        public static EquipCell47 CreateInstance()
        {
            return (EquipCell47)UIPackage.CreateObject("UIRes", "EquipCell47");
        }
