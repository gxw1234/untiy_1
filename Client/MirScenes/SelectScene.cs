...
namespace Client.MirScenes
{
    public class SelectScene : MirScene
    {
        ...
        public SelectScene(List<SelectInfo> characters)
        {
            ...
            Background.Location = new Point((Settings.ScreenWidth - Background.Size.Width) / 2, (Settings.ScreenHeight - Background.Size.Height) / 2);
            ...
            var xPoint = Background.Size.Width / 5;
            Size tmpSize = Libraries.Title.GetSize(340);
            ...
            StartGameButton = new MirButton
            {
                ...
                Index = 340,
                Library = Libraries.Title,
                Location = new Point((xPoint * 1 - xPoint) + (xPoint - tmpSize.Width) / 2, Background.Size.Height - 32),
                Parent = Background,
                PressedIndex = 342
            };
            ...
            NewCharacterButton = new MirButton
            {
                ...
                Index = 343,
                Library = Libraries.Title,
                Location = new Point((xPoint * 2 - xPoint) + (xPoint - tmpSize.Width) / 2, Background.Size.Height - 32),
                Parent = Background,
                PressedIndex = 345,
            };
            ...
            DeleteCharacterButton = new MirButton
            {
                ...
                Index = 346,
                Library = Libraries.Title,
                Location = new Point((xPoint * 3 - xPoint) + (xPoint - tmpSize.Width) / 2, Background.Size.Height - 32),
                Parent = Background,
                PressedIndex = 348
            };
            ...
            CreditsButton = new MirButton
            {
                ...
                Index = 349,
                Library = Libraries.Title,
                Location = new Point((xPoint * 4 - xPoint) + (xPoint - tmpSize.Width) / 2, Background.Size.Height - 32),
                Parent = Background,
                PressedIndex = 351
            };
            ...
            ExitGame = new MirButton
            {
                ...
                Index = 352,
                Library = Libraries.Title,
                Location = new Point((xPoint * 5 - xPoint) + (xPoint - tmpSize.Width) / 2, Background.Size.Height - 32),
                Parent = Background,
                PressedIndex = 354
            };
