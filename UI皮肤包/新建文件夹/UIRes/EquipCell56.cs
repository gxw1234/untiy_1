...
namespace UIRes
{
    public partial class EquipCell56 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98joo8o2";

        public static EquipCell56 CreateInstance()
        {
            return (EquipCell56)UIPackage.CreateObject("UIRes", "EquipCell56");
        }
