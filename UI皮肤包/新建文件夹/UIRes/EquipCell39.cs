...
namespace UIRes
{
    public partial class EquipCell39 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jr";

        public static EquipCell39 CreateInstance()
        {
            return (EquipCell39)UIPackage.CreateObject("UIRes", "EquipCell39");
        }
