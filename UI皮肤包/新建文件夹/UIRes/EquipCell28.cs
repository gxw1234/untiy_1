...
namespace UIRes
{
    public partial class EquipCell28 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21ib";

        public static EquipCell28 CreateInstance()
        {
            return (EquipCell28)UIPackage.CreateObject("UIRes", "EquipCell28");
        }
