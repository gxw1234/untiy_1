...
namespace UI
{
    public partial class ShenQi_DJewelryBoxUI : GComponent
    {
        ...
        public const string URL = "ui://jyvofh5ewzbbmi";

        public static ShenQi_DJewelryBoxUI CreateInstance()
        {
            return (ShenQi_DJewelryBoxUI)UIPackage.CreateObject("UI", "神器_DJewelryBoxUI");
        }
