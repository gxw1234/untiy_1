...
namespace UIRes
{
    public partial class EquipCell45 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98joy6sv";

        public static EquipCell45 CreateInstance()
        {
            return (EquipCell45)UIPackage.CreateObject("UIRes", "EquipCell45");
        }
