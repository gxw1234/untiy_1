...
namespace UIRes
{
    public partial class EquipCell23 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21i6";

        public static EquipCell23 CreateInstance()
        {
            return (EquipCell23)UIPackage.CreateObject("UIRes", "EquipCell23");
        }
