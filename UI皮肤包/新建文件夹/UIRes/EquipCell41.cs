...
namespace UIRes
{
    public partial class EquipCell41 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jt";

        public static EquipCell41 CreateInstance()
        {
            return (EquipCell41)UIPackage.CreateObject("UIRes", "EquipCell41");
        }
