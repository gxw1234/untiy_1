...
namespace UIRes
{
    public partial class EquipCell63 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21iy";

        public static EquipCell63 CreateInstance()
        {
            return (EquipCell63)UIPackage.CreateObject("UIRes", "EquipCell63");
        }
