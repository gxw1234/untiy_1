...
namespace UIRes
{
    public partial class EquipCell22 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jtrkvh";

        public static EquipCell22 CreateInstance()
        {
            return (EquipCell22)UIPackage.CreateObject("UIRes", "EquipCell22");
        }
