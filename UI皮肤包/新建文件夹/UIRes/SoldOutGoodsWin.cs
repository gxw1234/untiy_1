...
namespace UIRes
{
    public partial class SoldOutGoodsWin : GComponent
    {
        public GImage SoldOutGoodsWin;
        ...
        public const string URL = "ui://jk0io98jkn5z12s";

        public static SoldOutGoodsWin CreateInstance()
        {
            return (SoldOutGoodsWin)UIPackage.CreateObject("UIRes", "SoldOutGoodsWin");
        }
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            SoldOutGoodsWin = (GImage)GetChild("SoldOutGoodsWin");
