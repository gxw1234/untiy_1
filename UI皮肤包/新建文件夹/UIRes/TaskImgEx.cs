...
namespace UIRes
{
    public partial class TaskImgEx : GComponent
    {
        public GLoader load;
        ...
        public const string URL = "ui://jk0io98jv9b19a";

        public static TaskImgEx CreateInstance()
        {
            return (TaskImgEx)UIPackage.CreateObject("UIRes", "TaskImgEx");
        }
