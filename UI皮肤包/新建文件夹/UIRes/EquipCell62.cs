...
namespace UIRes
{
    public partial class EquipCell62 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jj881g";

        public static EquipCell62 CreateInstance()
        {
            return (EquipCell62)UIPackage.CreateObject("UIRes", "EquipCell62");
        }
