...
namespace UIRes
{
    public partial class CompetePriceGoodsWins : GComponent
    {
        public GImage CompetePriceGoodsWins;
        ...
        public const string URL = "ui://jk0io98jkn5z136";

        public static CompetePriceGoodsWins CreateInstance()
        {
            return (CompetePriceGoodsWins)UIPackage.CreateObject("UIRes", "CompetePriceGoodsWins");
        }
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            CompetePriceGoodsWins = (GImage)GetChild("CompetePriceGoodsWins");
