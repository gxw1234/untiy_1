...
namespace UIRes
{
    public partial class EquipCell7 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jj3e21hv";

        public static EquipCell7 CreateInstance()
        {
            return (EquipCell7)UIPackage.CreateObject("UIRes", "EquipCell7");
        }
