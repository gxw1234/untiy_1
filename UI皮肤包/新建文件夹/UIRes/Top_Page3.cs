...
namespace UIRes
{
    public partial class Top_Page3 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jjjkzgvn2wm";

        public static Top_Page3 CreateInstance()
        {
            return (Top_Page3)UIPackage.CreateObject("UIRes", "Top_Page3");
        }
