...
namespace Client.MirScenes
{
    public sealed class GameScene : MirScene
    {
        ...
        public static bool 毒符 = true; 
        public static long 技能延时 = 0L;
            ...
            switch (AMode)
            {
                ...
                case AttackMode.All:
                    ...
                    return;
                     ...
                     public int FinditemA(ItemType amulet, int shape)
                    {
                    int num = 0;
                    while (true)
                    {
                    if (num < GameScene.User.Inventory.Length)
                    {
                    UserItem userItem = GameScene.User.Inventory[num];
                    if (userItem != null && userItem.Info.Type == amulet && userItem.Info.Shape == shape)
                    {
                        break;
                    }
                        num++;
                        ...
                        GameScene.Scene.OutputMessage("辅助系统找到所需要的杂货!");
                        return num;
                    }
            ...
            if (毒符)
                    {
                        ...
                        if (magic.Icon == 12 || magic.Icon == 16 || magic.Icon == 17 || magic.Icon == 18 || magic.Icon == 13 || magic.Icon == 27 || magic.Icon == 14 || magic.Icon == 36 || magic.Icon == 15 || magic.Icon == 39 || magic.Icon == 28 || magic.Icon == 48 || magic.Icon == 35 || magic.Icon == 29 || magic.Icon == 53 || magic.Icon == 40 || magic.Icon == 45 || magic.Icon == 74 || magic.Icon == 54 || magic.Icon == 57 || magic.Icon == 78)
                        {
                            if (Scene.CharacterDialog.Grid[9].Item == null || Scene.CharacterDialog.Grid[9].Item.Info.Image != 270)
                            {
                                int num = FinditemA(ItemType.Amulet, 0);
                                if (num != -1)
                                {
                                    if (num > 6)
                                    {
                                        Scene.InventoryDialog.Grid[num - 6].UseItem();
                                    }
                                    else
                                    {
                                        new BeltDialog().Grid[num].UseItem();
                                    }
                                }
                            }
                        }
                        else if (magic.Icon == 5 && CMain.Time >= 技能延时)
                        {
                            if (Scene.CharacterDialog.Grid[9].Item == null || Scene.CharacterDialog.Grid[9].Item.Info.Image != 259)
                            {
                                int num2 = FinditemA(ItemType.Amulet, 1);
                                if (num2 != -1)
                                {
                                    if (num2 > 6)
                                    {
                                        Scene.InventoryDialog.Grid[num2 - 6].UseItem();
                                    }
                                    else
                                    {
                                        new BeltDialog().Grid[num2].UseItem();
                                    }
                                }
                                技能延时 = CMain.Time + 1100;
                            }
                            else if (Scene.CharacterDialog.Grid[9].Item == null || Scene.CharacterDialog.Grid[9].Item.Info.Image == 259)
                            {
                                int num3 = FinditemA(ItemType.Amulet, 2);
                                if (num3 != -1)
                                {
                                    if (num3 > 6)
                                    {
                                        Scene.InventoryDialog.Grid[num3 - 6].UseItem();
                                    }
                                    else
                                    {
                                        new BeltDialog().Grid[num3].UseItem();
                                    }
                                }
                                技能延时 = CMain.Time + 1100;
                            }
