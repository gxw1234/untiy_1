...
namespace UIRes
{
    public partial class EquipCell25 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jjvgmt";

        public static EquipCell25 CreateInstance()
        {
            return (EquipCell25)UIPackage.CreateObject("UIRes", "EquipCell25");
        }
