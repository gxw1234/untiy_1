...
namespace UIRes
{
    public partial class TaskItemShow : GComponent
    {
        public GLoader bg;
        ...
        public const string URL = "ui://jk0io98jv9b19g";

        public static TaskItemShow CreateInstance()
        {
            return (TaskItemShow)UIPackage.CreateObject("UIRes", "TaskItemShow");
        }
