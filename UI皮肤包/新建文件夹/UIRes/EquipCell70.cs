...
namespace UIRes
{
    public partial class EquipCell70 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21j4";

        public static EquipCell70 CreateInstance()
        {
            return (EquipCell70)UIPackage.CreateObject("UIRes", "EquipCell70");
        }
