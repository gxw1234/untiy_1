...
namespace UIRes
{
    public partial class EquipCell60 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21iv";

        public static EquipCell60 CreateInstance()
        {
            return (EquipCell60)UIPackage.CreateObject("UIRes", "EquipCell60");
        }
