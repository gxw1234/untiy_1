...
namespace UIRes
{
    public partial class EquipCell29 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21ic";

        public static EquipCell29 CreateInstance()
        {
            return (EquipCell29)UIPackage.CreateObject("UIRes", "EquipCell29");
        }
