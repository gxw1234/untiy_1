...
namespace UIRes
{
    public partial class BagGoodsItem : GComponent
    {
        public GImage BagGoodsItem;
        ...
        public const string URL = "ui://jk0io98jkn5z13b";

        public static BagGoodsItem CreateInstance()
        {
            return (BagGoodsItem)UIPackage.CreateObject("UIRes", "BagGoodsItem");
        }
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            BagGoodsItem = (GImage)GetChild("BagGoodsItem");
