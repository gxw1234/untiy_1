...
namespace UIRes
{
    public partial class EquipCell48 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21ij";

        public static EquipCell48 CreateInstance()
        {
            return (EquipCell48)UIPackage.CreateObject("UIRes", "EquipCell48");
        }
