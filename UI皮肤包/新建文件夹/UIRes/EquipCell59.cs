...
namespace UIRes
{
    public partial class EquipCell59 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21iu";

        public static EquipCell59 CreateInstance()
        {
            return (EquipCell59)UIPackage.CreateObject("UIRes", "EquipCell59");
        }
