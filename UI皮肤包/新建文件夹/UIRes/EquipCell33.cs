...
namespace UIRes
{
    public partial class EquipCell33 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jl";

        public static EquipCell33 CreateInstance()
        {
            return (EquipCell33)UIPackage.CreateObject("UIRes", "EquipCell33");
        }
