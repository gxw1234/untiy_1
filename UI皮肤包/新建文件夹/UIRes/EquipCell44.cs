...
namespace UIRes
{
    public partial class EquipCell44 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jw64c0";

        public static EquipCell44 CreateInstance()
        {
            return (EquipCell44)UIPackage.CreateObject("UIRes", "EquipCell44");
        }
