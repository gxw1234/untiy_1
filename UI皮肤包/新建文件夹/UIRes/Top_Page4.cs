...
namespace UIRes
{
    public partial class Top_Page4 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jjjkzgvn2wn";

        public static Top_Page4 CreateInstance()
        {
            return (Top_Page4)UIPackage.CreateObject("UIRes", "Top_Page4");
        }
