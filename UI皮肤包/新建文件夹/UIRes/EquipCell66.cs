...
namespace UIRes
{
    public partial class EquipCell66 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21j0";

        public static EquipCell66 CreateInstance()
        {
            return (EquipCell66)UIPackage.CreateObject("UIRes", "EquipCell66");
        }
