...
namespace UIRes
{
    public partial class EquipCell18 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21i1";

        public static EquipCell18 CreateInstance()
        {
            return (EquipCell18)UIPackage.CreateObject("UIRes", "EquipCell18");
        }
