...
namespace UIRes
{
    public partial class EquipCell37 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jp";

        public static EquipCell37 CreateInstance()
        {
            return (EquipCell37)UIPackage.CreateObject("UIRes", "EquipCell37");
        }
