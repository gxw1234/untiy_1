...
namespace UI
{
    public partial class SheZhi_DSetUI : GComponent
    {
        ...
        public const string URL = "ui://jyvofh5ekn5zyu";

        public static SheZhi_DSetUI CreateInstance()
        {
            return (SheZhi_DSetUI)UIPackage.CreateObject("UI", "设置_DSetUI");
        }
