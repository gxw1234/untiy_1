...
namespace BaseRes
{
    public partial class ItemShow : GComponent
    {
        public GLoader bg;
        ...
        public const string URL = "ui://use7blkkqgn290";

        public static ItemShow CreateInstance()
        {
            return (ItemShow)UIPackage.CreateObject("BaseRes", "ItemShow");
        }
