...
namespace UIRes
{
    public partial class Top_Page5 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jjjkzgvn2wo";

        public static Top_Page5 CreateInstance()
        {
            return (Top_Page5)UIPackage.CreateObject("UIRes", "Top_Page5");
        }
