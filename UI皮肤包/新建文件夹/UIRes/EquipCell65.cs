...
namespace UIRes
{
    public partial class EquipCell65 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21iz";

        public static EquipCell65 CreateInstance()
        {
            return (EquipCell65)UIPackage.CreateObject("UIRes", "EquipCell65");
        }
