...
namespace UIRes
{
    public partial class EquipCell8 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jtn4br";

        public static EquipCell8 CreateInstance()
        {
            return (EquipCell8)UIPackage.CreateObject("UIRes", "EquipCell8");
        }
