...
namespace Client.MirControls
{
    public class MirControl : IDisposable
    {
        ...
        protected UnityEngine.Texture2D ControlTexture;
        ...
        #region Font
        public virtual Shared.Unity.Font ScaleFont(Shared.Unity.Font font)
        {
            var theFont = new Shared.Unity.Font(font.Name, font.Size * 96f / 96, font.Style);
            // font.Dispose();
