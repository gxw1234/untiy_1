...
namespace UIRes
{
    public partial class DBtnAttack16 : GButton
    {
        ...
        public const string URL = "ui://jk0io98jj67ugvn2zc";

        public static DBtnAttack16 CreateInstance()
        {
            return (DBtnAttack16)UIPackage.CreateObject("UIRes", "DBtnAttack16");
        }
