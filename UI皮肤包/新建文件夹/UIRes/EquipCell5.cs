...
namespace UIRes
{
    public partial class EquipCell5 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jj3e21hw";

        public static EquipCell5 CreateInstance()
        {
            return (EquipCell5)UIPackage.CreateObject("UIRes", "EquipCell5");
        }
