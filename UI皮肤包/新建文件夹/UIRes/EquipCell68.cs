...
namespace UIRes
{
    public partial class EquipCell68 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jvh0g5";

        public static EquipCell68 CreateInstance()
        {
            return (EquipCell68)UIPackage.CreateObject("UIRes", "EquipCell68");
        }
