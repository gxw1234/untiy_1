...
namespace UIRes
{
    public partial class EquipCell32 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jk";

        public static EquipCell32 CreateInstance()
        {
            return (EquipCell32)UIPackage.CreateObject("UIRes", "EquipCell32");
        }
