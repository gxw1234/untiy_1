...
namespace UIRes
{
    public partial class EquipCell51 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jx03mq";

        public static EquipCell51 CreateInstance()
        {
            return (EquipCell51)UIPackage.CreateObject("UIRes", "EquipCell51");
        }
