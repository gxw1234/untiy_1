...
namespace UIRes
{
    public partial class EquipCell15 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21hz";

        public static EquipCell15 CreateInstance()
        {
            return (EquipCell15)UIPackage.CreateObject("UIRes", "EquipCell15");
        }
