...
namespace UIRes
{
    public partial class EquipCell30 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21ji";

        public static EquipCell30 CreateInstance()
        {
            return (EquipCell30)UIPackage.CreateObject("UIRes", "EquipCell30");
        }
