...
namespace UIRes
{
    public partial class MousePriceGoods : GComponent
    {
        public GImage MousePriceGoods;
        ...
        public const string URL = "ui://jk0io98jkn5z12y";

        public static MousePriceGoods CreateInstance()
        {
            return (MousePriceGoods)UIPackage.CreateObject("UIRes", "MousePriceGoods");
        }
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            MousePriceGoods = (GImage)GetChild("MousePriceGoods");
