...
namespace UIRes
{
    public partial class EquipCell43 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jqpvp2";

        public static EquipCell43 CreateInstance()
        {
            return (EquipCell43)UIPackage.CreateObject("UIRes", "EquipCell43");
        }
