...
namespace UIRes
{
    public partial class EquipCell46 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21ih";

        public static EquipCell46 CreateInstance()
        {
            return (EquipCell46)UIPackage.CreateObject("UIRes", "EquipCell46");
        }
