...
namespace UIRes
{
    public partial class EquipCell4 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jo7p58";

        public static EquipCell4 CreateInstance()
        {
            return (EquipCell4)UIPackage.CreateObject("UIRes", "EquipCell4");
        }
