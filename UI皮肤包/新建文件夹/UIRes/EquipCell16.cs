...
namespace UIRes
{
    public partial class EquipCell16 : GComponent
    {
        public GLoader bg;
        ...
        public const string URL = "ui://jk0io98jkn5zzp";

        public static EquipCell16 CreateInstance()
        {
            return (EquipCell16)UIPackage.CreateObject("UIRes", "EquipCell16");
        }
