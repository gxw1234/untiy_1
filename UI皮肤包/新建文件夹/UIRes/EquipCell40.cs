...
namespace UIRes
{
    public partial class EquipCell40 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21js";

        public static EquipCell40 CreateInstance()
        {
            return (EquipCell40)UIPackage.CreateObject("UIRes", "EquipCell40");
        }
