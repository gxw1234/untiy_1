...
namespace UIRes
{
    public partial class EquipCell55 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21iq";

        public static EquipCell55 CreateInstance()
        {
            return (EquipCell55)UIPackage.CreateObject("UIRes", "EquipCell55");
        }
