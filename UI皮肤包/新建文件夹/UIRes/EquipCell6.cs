...
namespace UIRes
{
    public partial class EquipCell6 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jqjod5";

        public static EquipCell6 CreateInstance()
        {
            return (EquipCell6)UIPackage.CreateObject("UIRes", "EquipCell6");
        }
