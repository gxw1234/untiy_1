...
namespace UIRes
{
    public partial class EquipCell10 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98ju481h";

        public static EquipCell10 CreateInstance()
        {
            return (EquipCell10)UIPackage.CreateObject("UIRes", "EquipCell10");
        }
