...
namespace UIRes
{
    public partial class EquipCell19 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21i2";

        public static EquipCell19 CreateInstance()
        {
            return (EquipCell19)UIPackage.CreateObject("UIRes", "EquipCell19");
        }
