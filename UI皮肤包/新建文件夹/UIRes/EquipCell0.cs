...
namespace UIRes
{
    public partial class EquipCell0 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jy451k";

        public static EquipCell0 CreateInstance()
        {
            return (EquipCell0)UIPackage.CreateObject("UIRes", "EquipCell0");
        }
