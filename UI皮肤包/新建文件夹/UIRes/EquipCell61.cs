...
namespace UIRes
{
    public partial class EquipCell61 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21iw";

        public static EquipCell61 CreateInstance()
        {
            return (EquipCell61)UIPackage.CreateObject("UIRes", "EquipCell61");
        }
