...
namespace UIRes
{
    public partial class EquipCell42 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21id";

        public static EquipCell42 CreateInstance()
        {
            return (EquipCell42)UIPackage.CreateObject("UIRes", "EquipCell42");
        }
