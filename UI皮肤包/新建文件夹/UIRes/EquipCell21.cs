...
namespace UIRes
{
    public partial class EquipCell21 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21i4";

        public static EquipCell21 CreateInstance()
        {
            return (EquipCell21)UIPackage.CreateObject("UIRes", "EquipCell21");
        }
