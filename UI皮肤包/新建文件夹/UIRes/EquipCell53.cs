...
namespace UIRes
{
    public partial class EquipCell53 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21io";

        public static EquipCell53 CreateInstance()
        {
            return (EquipCell53)UIPackage.CreateObject("UIRes", "EquipCell53");
        }
