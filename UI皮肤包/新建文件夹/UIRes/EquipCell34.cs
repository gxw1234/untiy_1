...
namespace UIRes
{
    public partial class EquipCell34 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jm";

        public static EquipCell34 CreateInstance()
        {
            return (EquipCell34)UIPackage.CreateObject("UIRes", "EquipCell34");
        }
