...
namespace UIRes
{
    public partial class EquipCell24 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21i7";

        public static EquipCell24 CreateInstance()
        {
            return (EquipCell24)UIPackage.CreateObject("UIRes", "EquipCell24");
        }
