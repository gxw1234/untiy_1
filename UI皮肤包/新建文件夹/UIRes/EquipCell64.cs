...
namespace UIRes
{
    public partial class EquipCell64 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21hy";

        public static EquipCell64 CreateInstance()
        {
            return (EquipCell64)UIPackage.CreateObject("UIRes", "EquipCell64");
        }
