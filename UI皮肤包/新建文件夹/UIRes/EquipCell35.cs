...
namespace UIRes
{
    public partial class EquipCell35 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jn";

        public static EquipCell35 CreateInstance()
        {
            return (EquipCell35)UIPackage.CreateObject("UIRes", "EquipCell35");
        }
