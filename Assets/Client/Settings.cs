...
namespace Client
{
    class Settings
    {
        ...
        public static float SizeRatio = 1.0f;
        ...
        public static string DataPath = resRootPath+"/Data/",
                            ...
                            SiegePath = resRootPath+"/Data/Siege/",
                            ...
                            MouseCursorPath = resRootPath+"/Data/Cursors/",
                            ResourcePath = resRootPath+"/DirectX/",
                            UserDataPath = resRootPath+"/Data/UserData/";
        ...
        // public static bool SmoothDraw = true;
        //平滑关闭
         public static bool DebugMode = true;
        public static bool SmoothDraw = false;
        ...
        public static string P_Host = @"https://mirfiles.com/mir2/cmir/patch/";
        ...
        public static void Load()
        {
            ...
            if (P_Host.ToLower() == "http://mirfiles.com/mir2/cmir/patch/")
            {
