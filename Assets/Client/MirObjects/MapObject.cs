...
namespace Client.MirObjects
{
    ...
    {
        public static Font ChatFont = new Font(Settings.FontName, 12F);
        ...
        public void Chat(string text)
        {
            ...
            for (int i = 1; i < text.Length; i++)
            {
                ...
                if (CMain.GetTextSize(text.Substring(index, i - index), ChatFont).Width > chatWidth)
                {
                    chat.Add(text.Substring(index, i - index - 1));
                    index = i - 1;
                }
        ...
        {
            DXManager.SetBlend(true, 0.75F); //0.8
            Draw();
            DXManager.SetBlend(false);
        }
        public virtual void DrawHightLightBlend()
        {
            DXManager.SetHightLightBlend(true, 0.6F); //0.8
            Draw();
            DXManager.SetHightLightBlend(false);
        }
