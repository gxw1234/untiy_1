...
namespace UIRes
{
    public partial class EquipCell12 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jq0n13";

        public static EquipCell12 CreateInstance()
        {
            return (EquipCell12)UIPackage.CreateObject("UIRes", "EquipCell12");
        }
