...
namespace UIRes
{
    public partial class EquipCell36 : GComponent
    {
        ...
        public const string URL = "ui://jk0io98jj3e21jo";

        public static EquipCell36 CreateInstance()
        {
            return (EquipCell36)UIPackage.CreateObject("UIRes", "EquipCell36");
        }
