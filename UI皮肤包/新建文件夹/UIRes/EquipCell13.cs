...
namespace UIRes
{
    public partial class EquipCell13 : GComponent
    {
        public GImage bg;
        ...
        public const string URL = "ui://jk0io98jw3xla";

        public static EquipCell13 CreateInstance()
        {
            return (EquipCell13)UIPackage.CreateObject("UIRes", "EquipCell13");
        }
